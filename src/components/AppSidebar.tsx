...
import { Home, LayoutDashboard, Settings, User, Users, Plus } from "lucide-react"
                        ...
                        <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                            ...
                            <DialogContent className="sm:max-w-[425px]">
                                ...
                                <DialogFooter>
                                    ...
                                    <Button type="submit" onClick={handleAddWorkspace}>Save Workspace</Button>
                                </DialogFooter>
                            </DialogContent>
                        </Dialog>
                    </SidebarGroupLabel>
                        ...
                        <SidebarMenu className="font-sm text-gray-700">
                            {workspaces.map((workspace: Workspace) => (
                                ...
                                >
                                    ...
                                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-brand-pnpm"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 17h4v4h-4z" /><path d="M10 17h4v4h-4z" /><path d="M17 17h4v4h-4z" /><path d="M17 10h4v4h-4z" /><path d="M17 3h4v4h-4z" /><path d="M10 10h4v4h-4z" /><path d="M10 3h4v4h-4z" /><path d="M3 3h4v4h-4z" /></svg>
