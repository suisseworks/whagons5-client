    ...
    <div className="h-full w-full flex flex-col gap-2 min-h-0">
      <Card className="flex-1 flex flex-col overflow-hidden min-h-0">
        <CardContent className="flex-1 min-h-0 flex flex-col pt-1 pb-1 overflow-hidden px-3 lg:px-6">
          ...
          <div className="flex-1 min-h-0 flex items-center justify-center" style={{ fontSize: '12px', lineHeight: '1.25', paddingRight: '16px' }}>
            {/* Bryntum Scheduler temporarily disabled */}
            <div className="text-center text-muted-foreground">
              <p>Scheduler view coming soon</p>
            </div>
            {/* <BryntumScheduler
              resources={resources}
              events={events}
