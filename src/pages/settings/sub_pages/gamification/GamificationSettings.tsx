...
export default function GamificationSettings() {
  ...
  const currentPlugin = pluginsConfig.find(p => p.id === 'gamification');

  const handleToggleEnabled = () => {
    togglePluginEnabled('gamification');
  };

  const handleTogglePinned = () => {
    togglePluginPinned('gamification');
  };
            ...
            <CardContent>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  />
                  <span className="text-sm">Set up gamification elements and rewards</span>
                </li>
                <li className="flex items-start gap-3">
                  <FontAwesomeIcon 
                    icon={faCheck} 
                    className="text-emerald-500 mt-1 flex-shrink-0" 
                  />
                  <span className="text-sm">Engage users with points, badges, and leaderboards</span>
                </li>
                <li className="flex items-start gap-3">
                  <FontAwesomeIcon 
                    icon={faCheck} 
                    className="text-emerald-500 mt-1 flex-shrink-0" 
                  />
                  <span className="text-sm">Track user achievements and progress</span>
                </li>
              </ul>
            </CardContent>
          </Card>
