...
export default function MotivationSettings() {
  ...
  const currentPlugin = pluginsConfig.find(p => p.id === 'motivation');

  const handleToggleEnabled = () => {
    togglePluginEnabled('motivation');
  };

  const handleTogglePinned = () => {
    togglePluginPinned('motivation');
  };
            ...
            <CardContent>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  />
                  <span className="text-sm">Configure motivation and engagement settings</span>
                </li>
                <li className="flex items-start gap-3">
                  <FontAwesomeIcon 
                    icon={faCheck} 
                    className="text-emerald-500 mt-1 flex-shrink-0" 
                  />
                  <span className="text-sm">Set up motivational quotes and reminders</span>
                </li>
                <li className="flex items-start gap-3">
                  <FontAwesomeIcon 
                    icon={faCheck} 
                    className="text-emerald-500 mt-1 flex-shrink-0" 
                  />
                  <span className="text-sm">Track user engagement and motivation metrics</span>
                </li>
              </ul>
            </CardContent>
          </Card>
