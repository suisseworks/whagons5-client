...
const genericSliceConfigs = [
    ...
    { name: 'statusTransitions', table: 'wh_status_transitions', endpoint: '/status-transitions', store: 'status_transitions', hashFields: ['id','category_id','from_status','to_status','requires_comment','requires_checklist_completed','requires_fields','updated_at'] },
